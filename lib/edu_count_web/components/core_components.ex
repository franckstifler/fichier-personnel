defmodule EduCountWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(EduCountWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(EduCountWeb.Gettext, "errors", msg, opts)
    end
  end
